...
import { PermissionCacheTypeConstants, PermissionModeConstants, RouterTransitionConstants, SessionTimeoutProcessingConstants, SettingButtonPositionConstants } from 'celeris-constants';
...
export const DEFAULT_PROJECT_SETTING: ProjectSetting = {
  ...
  // 权限模式
  // The permission mode
  permissionMode: PermissionModeConstants.BACKEND,
