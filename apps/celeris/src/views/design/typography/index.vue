...
<template>
  <NCard>
    <article class="article font-song chinese chinese-truegray">
      ...
      <blockquote>
        这是一个旨在优化<u>中文网站</u>或应用程序字体显示的项目。通过使用这个项目，您可以获得一个默认的字体排列方案，以确保在没有指定字体的情况下，页面中选择的字体尽可能符合<u>中文阅读</u>的要求。这个项目的字体排列方案是基于<u>中文阅读体验</u>的考虑，它优先选择在中文环境中广泛使用和受欢迎的字体，并根据字体支持的字形、符号以及跨平台支持来确定字体的优先级顺序。
      </blockquote>
      ...
      <h2 id="intro">介绍<a v-anchor="'#intro'" class="anchor">#</a></h2>
      <p>
        <ruby class="chinese-ruby--inline">unocss-preset-chinese</ruby
        ><ruby class="chinese-ruby--inline">-typography<rp>(</rp><rt lang="zh-Latn">排版</rt><rp>)</rp></ruby
      ...
      <h2 id="usage">使用方法<a v-anchor="'#usage'" class="anchor">#</a></h2>
...
&lt;/article&gt;</code></pre>
      ...
      <small
        >注：unocss-preset-chinese-typography是正文区域的样式增强，不是<i>CSS Reset</i>的替代。因此<b>不建议</b>将它作用在根标签（如<code>&lt;body&gt;</code>或<code
          >&lt;div id=&quot;app&quot;&gt;</code
        >）上。</small
      >
      ...
      <h2 id="examples">效果示例<a v-anchor="'#examples'" class="anchor">#</a></h2>
      <p>本页面<em>全页</em>应用了unocss-preset-chinese-typography样式，所见即所得。下面是内置的多种排版效果演示。</p>

      <h3 id="example-ancient">古文<a v-anchor="'#example-ancient'" class="anchor">#</a></h3>
      <details>
      ...
      <details open>
        ...
        <section class="demo">
          <div class="chinese chinese--ancient">
            <h1>出师表</h1>
            <p class="chinese-meta chinese-small">作者：<abbr title="字孔明">諸葛亮</abbr>（181年～234年10月8日）</p>
            <p>
      ...
      <h3 id="example-verse">诗词<a v-anchor="'#example-verse'" class="anchor">#</a></h3>
      <details>
        <summary>如何使用？</summary>
        <ul>
          <li>
...
&lt;/div&gt;</code></pre>
          ...
          <li>
            搭配使用标点悬挂<code>&lt;span class=&quot;chinese-hang&quot;&gt;</code>、元信息<code>&lt;span class=&quot;chinese-meta chinese-small&quot;&gt;</code>来丰富展示效果。
          </li>
        </ul>
      </details>
      <details open>
        ...
        <section class="demo">
          <div class="chinese chinese--ancient">
            <h2>
              一剪梅·红藕香残玉簟秋<span class="chinese-meta chinese-small">[宋]<abbr title="号易安居士">李清照</abbr></span>
            </h2>
            <p class="chinese-verse chinese-x-large">
              红藕香残玉簟秋。轻解罗裳，独上兰舟<span class="chinese-hang">。</span><br />
              云中谁寄锦书来，雁字回时，月满西楼<span class="chinese-hang">。</span><br />
          ...
          <div class="chinese chinese--poetry">
            <h2>
              好了歌<span class="chinese-meta chinese-small">[清]<abbr title="著曹雪芹">曹雪芹</abbr></span>
            </h2>
            <p class="chinese-x-large">
              世人都晓神仙好，惟有功名忘不了；<br />
              古今将相在何方？荒冢一堆草没了。<br />
      ...
      <h3 id="example-annotation">行间注<a v-anchor="'#example-annotation'" class="anchor">#</a></h3>
      <details>
        <summary>如何使用？</summary>
        <p>
          为容器元素<code>&lt;div class=&quot;chinese&quot;&gt;</code>添加名为<code>chinese--annotation</code>的class后，搭配<code>&lt;ruby&gt;</code>元素即可实现整齐的行间注效果：
        </p>
      ...
      <details open>
        ...
        <section class="demo">
          <div class="chinese chinese--ancient chinese--annotation">
            <h2>庖丁解牛</h2>
            <p class="chinese-meta chinese-small">作者：<abbr title="庄子">庄周</abbr>（公元前369～公元前286年）</p>
            <p>吾生也有涯，而知也无涯。以有涯随无涯，殆已！已而为知者，殆而已矣！为善无近名，为恶无近刑。缘督以为经，可以保身，可以全生，可以养亲，可以尽年。</p>
            <p>
              <u title="名丁的厨工。先秦古书往往以职业放在人名前"
                ><ruby>庖<rp>(</rp><rt lang="zh-Latn">páo</rt><rp>)</rp></ruby>丁</u
              >为文惠君解牛，手之所触，肩之所倚，足之所履，膝之所<u title="支撑，接触"
                ><ruby>踦<rp>(</rp><rt lang="zh-Latn">yǐ</rt><rp>)</rp></ruby></u
              >，<u title="砉然：砉，又读xū，象声词。砉然，皮骨相离的声音"
                ><ruby>砉<rp>(</rp><rt lang="zh-Latn">huā</rt><rp>)</rp></ruby>然</u
              ><ruby>向<rp>(</rp><rt lang="zh-Latn">xiǎng</rt><rp>)</rp></ruby>然，奏刀<u title="騞然：象声词，形容比砉然更大的进刀解牛声"
                ><ruby>騞<rp>(</rp><rt lang="zh-Latn">huō</rt><rp>)</rp></ruby>然</u
              >，莫不中音。合于《桑林》之舞，乃中《经首》之会。
            </p>
            <p>
              文惠君曰：「嘻，善哉！技<u title="通「盍」，何，怎样"
                ><ruby>盖<rp>(</rp><rt lang="zh-Latn">hé</rt><rp>)</rp></ruby></u
              >至此乎？」
            </p>
            <p>
              庖丁释刀对曰：「臣之所好者，道也，进乎技矣。始臣之解牛之时，所见无非牛者。三年之后，未尝见全牛也。方今之时，臣以神遇而不以目视，官知止而<u title="指精神活动">神欲</u
              >行。依乎<u title="指牛的生理上的天然结构">天理</u>，<u title="击入大的缝隙"
                >批大<ruby>郤<rp>(</rp><rt lang="zh-Latn">xì</rt><rp>)</rp></ruby></u
              >，<u title="顺着（骨节间的）空处进刀"
                >导大<ruby>窾<rp>(</rp><rt lang="zh-Latn">kuǎn</rt><rp>)</rp></ruby></u
              >，<u title="依">因</u>其<u title="指牛体本来的结构">固然</u>，技经肯<ruby>綮<rp>(</rp><rt lang="zh-Latn">qìng</rt><rp>)</rp></ruby>之未尝，而况大<ruby
                >軱<rp>(</rp><rt lang="zh-Latn">gū</rt><rp>)</rp></ruby
              >乎！良庖岁更刀，割也；族庖月更刀，折也。今臣之刀十九年矣，所解数千牛矣，而刀刃若新发于<ruby>硎<rp>(</rp><rt lang="zh-Latn">xíng</rt><rp>)</rp></ruby
              >。彼节者有间，而刀刃者无厚；以无厚入有间，恢恢乎其于<em>游刃必有余地</em>矣，是以十九年而刀刃若新发于硎。虽然，每至于族，吾见其难为，<ruby
                >怵<rp>(</rp><rt lang="zh-Latn">chù</rt><rp>)</rp></ruby
              >然为戒，视为止，行为迟。动刀甚微，<ruby>謋<rp>(</rp><rt lang="zh-Latn">huò</rt><rp>)</rp></ruby>然已解，如土委地。提刀而立，为之四顾，为之<ruby
                >踌<rp>(</rp><rt lang="zh-Latn">chóu</rt><rp>)</rp>躇<rp>(</rp><rt lang="zh-Latn">chú</rt><rp>)</rp></ruby
              >满志，善刀而藏之。」
            </p>
      ...
      <h3 id="example-columns">多栏排版<a v-anchor="'#example-columns'" class="anchor">#</a></h3>
      ...
      <h3 id="example-vertical">竖排排版<a v-anchor="'#example-vertical'" class="anchor">#</a></h3>
          ...
          <figure class="card card--vertical">
            <div class="card__vertical-container">
              <section class="chinese--vertical chinese--ancient">
                <h1>出師表</h1>
                <p class="chinese-small">作者：<abbr title="字孔明">諸葛亮</abbr>（181年－234年10月8日）</p>
      ...
      <h2 id="guidelines">设计原则<a v-anchor="'#guidelines'" class="anchor">#</a></h2>
      <p>它不作为一个CSS Reset出现，而是根据通行的中文排版规范，对网页正文区域进行排版样式增强。</p>
      <h3>文字</h3>
      <p>
        参考《中文排版需求<sup><a id="ref-01" v-anchor="'#fn-01'">[1]</a></sup
        >》中描述的常用书籍排版字体，提供了黑体、宋体和<u title="以正文宋体、标题楷体构成的搭配">传统</u
        >三种字体风格，前两者分别对应无衬线、衬线字体族。文字默认采用16px作为标准字号。在标题等文字较大的情况下，会适当地增加字间距以便获得更好地可读性。
      </p>
      <details>
      ...
      <h2 id="appendix">附录<a v-anchor="'#appendix'" class="anchor">#</a></h2>
      <h3 id="tags">标签示例表<a v-anchor="'#tags'" class="anchor">#</a></h3>
      <details open>
        ...
        <section class="section">
          <table>
            ...
            <tr>
              <td>着重号</td>
              <td>
                <code>我们<span class="chinese-em">绝不会</span>放弃。</code>
              </td>
