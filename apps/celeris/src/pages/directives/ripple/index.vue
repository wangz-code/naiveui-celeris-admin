...
<template>
	...
	<img :src="HeroImg" class="rounded-2xl object-cover min-h-[56px] max-h-[400px] w-1/2" alt="Two containers that display a bounded and unbounded ripple on interaction." title="A bounded and unbounded ripple." />
</template>
