...
<template>
	<NCard>
		<article class="article font-song chinese chinese-truegray">
			...
			<p>
				<ruby class="chinese-ruby--inline">unocss-preset-chinese</ruby><ruby class="chinese-ruby--inline">-typography<rp>(</rp><rt lang="zh-Latn">排版</rt><rp>)</rp></ruby>是专为中文网页内容设计的排版样式增强。它基于通行的中文排版规范，可为网站的读者带来更好的内容阅读体验。它的主要特性有：
			</p>
			<ul>
				<li>贴合网格的排版；</li>
				<li>全标签样式美化；</li>
...
&lt;/div&gt;</code></pre>
			...
			<details open>
				...
				<section class="demo">
					<div class="chinese chinese--ancient chinese--annotation">
						...
						<p>
							庖丁释刀对曰：「臣之所好者，道也，进乎技矣。始臣之解牛之时，所见无非牛者。三年之后，未尝见全牛也。方今之时，臣以神遇而不以目视，官知止而<u title="指精神活动">神欲</u>行。依乎<u title="指牛的生理上的天然结构">天理</u>，<u title="击入大的缝隙"
							...
							>，<u title="依">因</u>其<u title="指牛体本来的结构">固然</u>，技经肯<ruby>綮<rp>(</rp><rt lang="zh-Latn">qìng</rt><rp>)</rp></ruby>之未尝，而况大<ruby>軱<rp>(</rp><rt lang="zh-Latn">gū</rt><rp>)</rp></ruby>乎！良庖岁更刀，割也；族庖月更刀，折也。今臣之刀十九年矣，所解数千牛矣，而刀刃若新发于<ruby>硎<rp>(</rp><rt lang="zh-Latn">xíng</rt><rp>)</rp></ruby
							>。彼节者有间，而刀刃者无厚；以无厚入有间，恢恢乎其于<em>游刃必有余地</em>矣，是以十九年而刀刃若新发于硎。虽然，每至于族，吾见其难为，<ruby>怵<rp>(</rp><rt lang="zh-Latn">chù</rt><rp>)</rp></ruby>然为戒，视为止，行为迟。动刀甚微，<ruby>謋<rp>(</rp><rt lang="zh-Latn">huò</rt><rp>)</rp></ruby>然已解，如土委地。提刀而立，为之四顾，为之<ruby>踌<rp>(</rp><rt lang="zh-Latn">chóu</rt><rp>)</rp>躇<rp>(</rp><rt lang="zh-Latn">chú</rt><rp>)</rp></ruby>满志，善刀而藏之。」
						</p>
			...
			<p>
				...
				>》中描述的常用书籍排版字体，提供了黑体、宋体和<u title="以正文宋体、标题楷体构成的搭配">传统</u>三种字体风格，前两者分别对应无衬线、衬线字体族。文字默认采用16px作为标准字号。在标题等文字较大的情况下，会适当地增加字间距以便获得更好地可读性。
			</p>
			<details>
