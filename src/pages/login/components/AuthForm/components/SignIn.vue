...
<template>
	<NForm ref="loginFormRef" :model="loginFormModel" :rules="loginRules">
		...
		<NFormItem path="password" :label="t('page.login.form.password.label')">
			<NInput v-model:value="loginFormModel.password" type="password" :placeholder="t('page.login.form.password.placeholder')" show-password-on="click" autocomplete="on" size="large" @keydown.enter="signIn" />
		</NFormItem>
